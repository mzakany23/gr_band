<playlist-viewer>
	<div class="albums-block">
                <div class="row">
                    <div each={ playlist in opts.playlists } class="item col-xs-6 col-md-4">
                        <div class="item-inner">
                            ...
                            <div class="cover-holder">
                                ...
                                <a href="#" class="btn btn-sm btn-ghost-secondary" onclick={ showPlaylist }>{ playlist.title }</a>
            ...
            <div class="container">
            	<h2 id='tracks'>{ currentPlaylist.title }: tracks</h2>
            </div>
